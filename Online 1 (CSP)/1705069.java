...
public class Suguru {
    ...
    public static void main(String[] args) {
        ...
        IntVar[] b6 = model.intVarArray("b6", 1, 1, 1);
        ...
        model.arithm(board[0][3], "=", b1[0]).post();
        model.arithm(board[0][2], "=", b1[1]).post();
        ...
        model.arithm(board[4][0], "=", b6[0]).post();
        
        
        model.arithm(board[5][0], "=", b7[0]).post();
        model.arithm(board[5][1], "=", b7[1]).post();
        model.arithm(board[5][2], "=", b7[2]).post();
        model.arithm(board[5][3], "=", b7[3]).post();
        model.arithm(board[5][4], "=", b7[4]).post();
